package com.wakedata.common.mybatis.plus.method;
...
import com.wakedata.common.mybatis.plus.enums.CustomSqlMethodEnum;
...
public class InsertByBatch extends AbstractMethod {
    ...
    public InsertByBatch(String methodName) {
        super(methodName);
    }
